...
- **Services**: Located in `Services/`. Handles external interactions and business logic (e.g., `YtDlpService` for managing yt-dlp binaries and execution, supporting resolution limits, format selection, and playlist downloads).
